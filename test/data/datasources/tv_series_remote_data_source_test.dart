...
void main() {
  ...
  late TvSeriesRemotaDataSourceImpl dataSource;
  late MockHttpClient mockHttpClient;

  setUp(() {
    mockHttpClient = MockHttpClient();
    dataSource = TvSeriesRemotaDataSourceImpl(client: mockHttpClient);
  });
  ...
  group('search tv series', () {
    final tSearchResult = TvSeriesResponse.fromJson(json
            .decode(readJson('dummy_data/search_game_of_throne_series.json')))
        .tvSeriesList;
    ...
    test('should return list of tv series when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/search_game_of_throne_series.json'), 200));
      // act
